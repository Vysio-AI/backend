...
const requestStructures = {
  ...
  '/api/v1/sessions': {
    ...
    'POST': new RequestStructure(
      ...
      new RequestParameter('clientNotes', TypeValidator.STRING, false),
      new RequestParameter('publicPractitionerNotes', TypeValidator.STRING, false),
      new RequestParameter('privatePractitionerNotes', TypeValidator.STRING, false),
    ),
  },
  '/api/v1/sessions/:id': {
    'GET': new RequestStructure(),
